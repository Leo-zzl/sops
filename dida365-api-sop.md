...
3. 保存后获取：
   - **Client ID：** `sOlT2c4G7r0gOFkDAc`
   - **Client Secret：** `jvsoES62Say9r4G2F2Ar5FjOVnDn2M9P`
...
4. 浏览器跳转到：
   ```
   http://localhost:3000/callback?code=mS2oan&state=aria_123456
   ```
5. **提取 `code` 参数：** `mS2oan`
...
```bash
CLIENT_ID="sOlT2c4G7r0gOFkDAc"
CLIENT_SECRET="jvsoES62Say9r4G2F2Ar5FjOVnDn2M9P"
CODE="mS2oan"  # 上一步获取的 Code
REDIRECT_URI="http://localhost:3000/callback"
...
```json
{
  "access_token": "10967077-5a8a-4574-8fa3-b91abbd6360f",
  "token_type": "bearer",
  "expires_in": 15551999,
...
```bash
# 1. 设置环境变量
export DIDA365_ACCESS_TOKEN="10967077-5a8a-4574-8fa3-b91abbd6360f"
